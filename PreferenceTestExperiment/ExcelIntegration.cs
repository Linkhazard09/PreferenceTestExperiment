    ...
    class ExcelIntegration
    {
        ...
        public void CreatePart2(string Filepath)
        {
            ...
            catch
            {
                ...
                MessageBox.Show("Please ensure that the excel file selected exists or is not currently opened. Please restart the application","Error Accessing Excel File");
                return;
        ...
        //Relevant
        public void WriteToExcel2(string Filepath,string ParticipantName, string Sequence, int[] Scores)
        {
